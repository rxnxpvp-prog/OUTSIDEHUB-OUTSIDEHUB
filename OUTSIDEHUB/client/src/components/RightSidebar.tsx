          ...
          members.map((m) => (
            ...
            >
              <div style={{ position: "relative", flexShrink: 0 }}>
                ...
                {m.id === user?.id && (
                  <div style={{ position: "absolute", bottom: -1, right: -1, width: 8, height: 8, borderRadius: "50%", background: "#22c55e", border: "1.5px solid var(--background)" }} />
                )}
              </div>
              ...
              {m.badges?.length > 0 && (
                <span style={{ fontSize: 13, flexShrink: 0 }} title={m.badges[0].name}>
                  {m.badges[0].icon}
                </span>
              )}
            </div>
